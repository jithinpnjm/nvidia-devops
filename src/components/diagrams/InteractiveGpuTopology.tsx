...
const nodes = [
  ...
  {id: 'pcie', label: 'PCIe switch', x: 210, y: 30, href: '/curriculum/volume-04/gpu-architecture-topology-masterclass'},
  {id: 'gpu', label: 'GPU', x: 400, y: 10, href: '/curriculum/volume-04/gpu-architecture-topology-masterclass'},
  {id: 'nvlink', label: 'NVLink', x: 400, y: 100, href: '/curriculum/volume-04/gpu-architecture-topology-masterclass'},
  {id: 'nic', label: 'NIC / RDMA', x: 210, y: 140, href: '/curriculum/volume-06/ai-networking-rdma-masterclass'},
];
