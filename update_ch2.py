with open('docs/nvidia-zero-to-hero/volume-01/chapter-02-why-cpus-became-insufficient.md', 'w') as f:
    f.write(r"""---
title: "Chapter 2 — Why CPUs Became Insufficient"
slug: "/nvidia-zero-to-hero/volume-01/why-cpus-became-insufficient"
sidebar_position: 2
