---
title: "Chapter 18 — The Python object model, mutability and interfaces"
slug: "senior-deep-dive-1-the-python-object-model-mutability-and-interfaces"
sidebar_position: 18
description: "Chapter 1 — The Python object model, mutability and interfaces — Python for Production Infrastructure."
...
```
**Key takeaway:** *"A variable is a label, not a box."* Copy or freeze at boundaries when a caller must not share mutable state with your policy.
