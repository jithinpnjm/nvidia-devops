---
title: "Chapter 21 — Async, threads and processes with backpressure"
slug: "senior-deep-dive-4-async-threads-and-processes-with-backpressure"
sidebar_position: 21
description: "Chapter 4 — Async, threads and processes with backpressure — Python for Production Infrastructure."
...
```
**Key takeaway:** *"CPU parallelizes; I/O overlaps."* The execution model follows the bottleneck, not fashion.
