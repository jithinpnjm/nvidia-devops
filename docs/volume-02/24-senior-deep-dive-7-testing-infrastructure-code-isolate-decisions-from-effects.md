---
title: "Chapter 24 — Testing infrastructure code: isolate decisions from effects"
slug: "senior-deep-dive-7-testing-infrastructure-code-isolate-decisions-from-effects"
sidebar_position: 24
description: "Chapter 7 — Testing infrastructure code: isolate decisions from effects — Python for Production Infrastructure."
...
```
**Key takeaway:** *"Many cheap policy tests; few expensive boundary tests."*
