...
graph TD
    ...
    subgraph GPUDirect Storage [GDS Path]
...
Tier 1 Cache]
        ...
        NIC1[ConnectX-7 NIC 0
NDR 400Gb/s]
        NIC2[ConnectX-7 NIC 1
NDR 400Gb/s]
    end
    ...
    PFS_OSS <==>|Dataset Streaming
Checkpoint Bursts| NIC1
    PFS_OSS <==>|Dataset Streaming
Checkpoint Bursts| NIC2
