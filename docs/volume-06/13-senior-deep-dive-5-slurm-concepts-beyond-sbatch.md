---
title: "Chapter 13 — Slurm concepts beyond sbatch"
slug: "senior-deep-dive-5-slurm-concepts-beyond-sbatch"
sidebar_position: 13
description: "Chapter 5 — Slurm concepts beyond sbatch — HPC, Networking and Storage for AI."
...
**GRES vs TRES, concretely — the core explanation names both, this is the distinction spelled out:**
```
...
**Prolog/epilog failure — the core explanation's warning ("failures there can make nodes drain or jobs fail before user code runs"), as a concrete incident pattern:**
```
