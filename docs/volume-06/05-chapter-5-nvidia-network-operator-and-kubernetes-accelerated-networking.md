...
**The "two networks per pod" architecture, drawn out — this is the working model the original two paragraphs are describing:**
```mermaid
flowchart TB
...
**Worked scenario — the identity/policy/observability gap the core explanation flags but doesn't resolve:**
