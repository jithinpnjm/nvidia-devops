---
title: "Chapter 13 — NVIDIA Dynamo: system-level inference optimization"
slug: "senior-deep-dive-4-nvidia-dynamo-system-level-inference-optimization"
sidebar_position: 13
description: "Chapter 4 — NVIDIA Dynamo: system-level inference optimization — AI Workloads and AI Platform Architecture."
...
NVIDIA Dynamo became GA in 2026 as a distributed inference platform. It adds system-level capabilities around inference engines: request routing, KV cache management, disaggregated serving, data transfer, scaling and Kubernetes-native deployment. The key working model is that the engine optimizes execution on GPUs while Dynamo coordinates the distributed system around those engines.
...
**Diagram: the working model — engine vs. Dynamo layer boundary**
```mermaid
flowchart TD
