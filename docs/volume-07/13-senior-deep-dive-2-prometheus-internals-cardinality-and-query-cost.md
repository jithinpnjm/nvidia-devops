---
title: "Chapter 13 — Prometheus internals, cardinality and query cost"
slug: "senior-deep-dive-2-prometheus-internals-cardinality-and-query-cost"
sidebar_position: 13
description: "Chapter 2 — Prometheus internals, cardinality and query cost — Observability, Reliability and Troubleshooting."
...
```
**Key takeaway:** *"Labels are an index; every index has a bill."*
