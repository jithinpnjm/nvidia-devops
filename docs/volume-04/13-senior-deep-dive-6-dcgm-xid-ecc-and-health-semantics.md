---
title: "Chapter 13 — DCGM, Xid, ECC and health semantics"
slug: "senior-deep-dive-6-dcgm-xid-ecc-and-health-semantics"
sidebar_position: 13
description: "Chapter 6 — DCGM, Xid, ECC and health semantics — GPU and Accelerated Computing Foundations."
...
flowchart TD
    ...
    ACTION -.-> OUTCOME
```
**Key takeaway:** *"Metric says what; driver log says where; recurrence says whether."* Never drain—or dismiss—a GPU from a lone counter.
