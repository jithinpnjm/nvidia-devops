...
*(original diagram: media/image2.png — "reclaim and swap can occur before the OOM path is forced to select a victim" — preserved, reinsert as Figure 2 in final doc)*
...
➕ **Reclaim order, precisely (this is what the original Figure 2 is illustrating — worth stating in words too):**
```
