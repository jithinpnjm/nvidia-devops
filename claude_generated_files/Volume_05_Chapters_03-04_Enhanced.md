...
*(original diagram: media/image1.png — preserved — "Figure 1. The model server is one stage in a production request system with routing, state/caches, GPU and observability.")*
