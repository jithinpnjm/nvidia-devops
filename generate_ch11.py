...
$$ MFU = \frac{\text{Achieved FLOPs/sec}}{\text{Peak Theoretical FLOPs/sec}} $$
...
"""
    ...
    while len(lines) < 251:
        lines.append("")
    with open("docs/nvidia-zero-to-hero/volume-13/chapter-11-performance-engineering-and-troubleshooting.md", "w") as f:
        f.write('\n'.join(lines))
